...
using UnityEngine.Purchasing.Security;
    ...
    public class IAPProductInfo
    {
        ...
        [Space(10)] [Header("Price of product ($)")]
...
#endif
    {
        ...
        [SerializeField] private string    urlConfigInApp    = "";
        [SerializeField] private TextAsset textConfigDefault = null;
        ...
        private void F4ACoreManager_OnDownloadF4AConfigCompleted(F4AConfigData configData, bool success)
        {
            ...
            if (F4ACoreManager.Instance.IsGetConfigOnline)
            {
                ...
                {
                    StartCoroutine(DMCMobileUtils.AsyncGetDataFromUrl(urlConfigInApp, textConfigDefault,
                        (string data) =>
                        {
        ...
        public EStatusBuyIAP BuyProductByID(string productId)
        {
            ...
            EventsManager.Instance.LogEvent(DMCF4AConst.EventNameBuyIAP, new Dictionary<string, object>
            {
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            try
            {
                ...
                EventsManager.Instance.LogEvent(DMCF4AConst.EventNameBuyIAP,
        ...
        public bool ProductAvailableToPurchase(IAPProductInfo product)
        {
            if (product != null)
            {
                ...
                {
                    var productStore =
 m_StoreController.products.all.Where(pro => pro.definition.id.Equals(product.Id)).FirstOrDefault();
